...
public class RecyclerViewDaftarKrs extends AppCompatActivity {
    ...
    public void tambahData(){
        ...
        krsArrayList.add(new Krs("SI001","DDP","Senin","3","1","Pak Katon","600"));
        krsArrayList.add(new Krs("SI002","ABD","Senin","3","2","Pak Katon","100"));
        krsArrayList.add(new Krs("SI003","IMK","Senin","3","3","Bu Umi","78"));
        krsArrayList.add(new Krs("SI004","MTK SI","Senin","3","4","Pak Siang","1324"));
    }
}
