...
public class RecyclerViewDaftarDosen extends AppCompatActivity {
    ...
    private void tambahData(){
        ...
        dosenList.add(new Dosen("001","Pak Siang", "Wali","siang@staff.ukdw.ac.id","DIY",R.drawable.logo));
        dosenList.add(new Dosen("001","Pak Katon", "Dosen Coding","Katon@staff.ukdw.ac.id","DIY",R.drawable.logo));
        dosenList.add(new Dosen("001","Bu Umi", "Dosen Wanita","Umi@staff.ukdw.ac.id","DIY",R.drawable.logo));
    }
}
